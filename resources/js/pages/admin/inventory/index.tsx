            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-500">{parts.length} regels</span>
                    </div>
                </div>

                {parts.length === 0 ? (
                    <p className="p-4 text-sm text-gray-400">Nog geen onderdelen in voorraad.</p>
                ) : (
                    <>
                            ...
                            {parts.map((part) => (
                                <div key={part.id} className={`p-4 space-y-2 ${part.low_stock ? 'bg-amber-50/60' : ''}`}>
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="font-medium text-gray-900 min-w-0 truncate">{part.name}</div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        <div className="rounded-lg bg-gray-50 px-3 py-2">
                                            ...
                                            {part.procurement_status !== 'binnen' && part.requested_quantity > 0 && (
                                                <div className="text-[11px] text-gray-500">Aangevraagd: {part.requested_quantity}</div>
                                            )}
                                        </div>
                                        <div className="rounded-lg bg-gray-50 px-3 py-2">
